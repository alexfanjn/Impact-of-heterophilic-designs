...
class GCN0000(torch.nn.Module):
    def __init__(self, data, num_features, num_hidden, num_classes, dropout, device='cpu'):
        ...
        self.gcn1 = SAGEConv(num_features, num_hidden)
        self.gcn2 = SAGEConv(num_hidden, num_classes)
...
class GCN1000(torch.nn.Module):
    def __init__(self, data, num_features, num_hidden, num_classes, dropout, device='cpu'):
        ...
        self.gcn1 = SAGEConv(num_features, num_hidden)
        self.gcn2 = SAGEConv(2 * num_hidden, num_classes)
...
class GCN0010(torch.nn.Module):
    def __init__(self, data, num_features, num_hidden, num_classes, dropout, device='cpu'):
        ...
        self.gcn1 = GINConv(nn=torch.nn.Linear(num_features, num_hidden), train_eps=True)
        self.gcn2 = GINConv(nn=torch.nn.Linear(num_hidden, num_classes), train_eps=True)
    ...
    def forward(self, data):
        ...
        R1 = F.relu(F.dropout(h1, p=self.dropout, training=self.training))
...
class GCN1100(torch.nn.Module):
    def __init__(self, data, num_features, num_hidden, num_classes, dropout, device='cpu'):
        ...
        self.gcn1 = SAGEConv(num_features, num_hidden)
        self.gcn2 = SAGEConv(3 * num_hidden, num_classes)
...
class GCN1010(torch.nn.Module):
    def __init__(self, data, num_features, num_hidden, num_classes, dropout, device='cpu'):
        ...
        self.gcn1 = GINConv(nn=torch.nn.Linear(num_features, num_hidden), train_eps=True)
        self.gcn2 = GINConv(nn=torch.nn.Linear(2 * num_hidden, num_classes), train_eps=True)
...
class GCN1110(torch.nn.Module):
    def __init__(self, data, num_features, num_hidden, num_classes, dropout, device='cpu'):
        ...
        self.gcn1 = GINConv(nn=torch.nn.Linear(num_features, num_hidden), train_eps=True)
        self.gcn2 = GINConv(nn=torch.nn.Linear(3 * num_hidden, num_classes), train_eps=True)
